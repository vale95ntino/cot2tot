...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "This is (a test) string with (multiple) matches.",
            "(",
            ")",
            ["a test", "multiple"],
        ),
        ...
        (
            "[start]Only one match[end]",
            "[start]",
            "[end]",
            ["Only one match"],
        ),  # Exact match
        (
            "Multiple [key]values[key] in [key]a row[key]",
            "[key]",
            "[key]",
            ["values", "a row"],
        ),  # Same start and end
        ...
        (
            "Data [start]first[end][start]second[end][start]third[end]",
            "[start]",
            "[end]",
            ["first", "second", "third"],
        ),
